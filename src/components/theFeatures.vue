<template>
  <section>
    <v-row>
      ...
      <v-col class="flex-center" cols="4"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="award"
      ...
      <v-col class="flex-center" cols="4"><svg aria-hidden="true" focusable="false" data-prefix="fas"
          data-icon="trophy-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
