    ...
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="5 position-relative">
          ...
          <label for="navSearvh" class="search-icon"><v-icon>mdi-magnify</v-icon></label>
        </v-col>
        <v-col cols="4">
          <div class="icons-parent d-flex justify-space-between align-center">
            <div class="nax-text">
              <span>Available 24/7 at</span>
              <br>
              <strong>(090) 123-4567</strong>
            </div>
            <div class="wish-lists d-flex flex-column align-center">
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"></path>
            ...
            <div class="signIn d-flex flex-column align-center">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                class="icon icon-account" viewBox="0 0 1024 1024" width="100%" height="100%">
                <title>user</title>
                <path class="path1"
            ...
            <div @click="closeDrawer" class="cart d-flex flex-column align-center cursor-pointer">
        ...
        <v-col cols="5" class="d-flex justify-end align-center ga-16">
          ...
          <div class="language">
            <div v-html="selectedLang[0].icon"></div>
            <span>{{ selectedLang[0].title }}</span>
            <v-menu>
              <template v-slot:activator="{ props }">
                <v-btn icon="mdi-chevron-down" variant="text" v-bind="props"></v-btn>
              </template>

              <v-list v-model:selected="selectedLang">
                <v-list-item v-for="(lang, i) in languages" :key="i" :value="lang">
                  <v-list-item-title class="d-flex ga-2">
                    <div v-html="lang.icon"></div> {{ lang.title }}
                  </v-list-item-title>
                </v-list-item>
              </v-list>
            </v-menu>
...
const languages = ref<lang[]>([
  {
    title: 'EN / USD', icon: `  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 512 512"
              style="enable-background:new 0 0 512 512; width: 20px"  xmlns:xlink="http://www.w3.org/1999/xlink"
              xml:space="preserve">
  ...
  {
    title: 'DE / EURO', icon: `  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; width: 20px" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
