      ...
      <v-row>
        ...
        <v-col cols="5 position-relative">
          <input
            type="search"
            id="navSearvh"
            style="width: 80%; border-radius: 50px; outline: none"
            class="py-3 px-4 bg-white"
            placeholder="Search the store"
          />
          <label for="navSearvh" class="search-icon"
            ><v-icon>mdi-magnify</v-icon></label
          >
        </v-col>
        <v-col cols="4">
        ...
        <v-col cols="7">
          <ul
            class="links d-flex text-white justify-space-between mt-5"
